...
class EventSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('events')->insert([
            ...
            'time' => \Carbon\Carbon::parse('2024-08-26 08:00'),
        ...
        DB::table('events')->insert([
            ...
            'name' => "Melodrama tour",
            'artist' => "Lorde",
            'time' => \Carbon\Carbon::parse('2024-09-01 20:00'),
        ...
        DB::table('events')->insert([
            ...
            'artist' => "McFly",
            'time' => \Carbon\Carbon::parse('2024-05-16 18:00'),
        ...
        DB::table('events')->insert([
            ...
            'artist' => "Scooter",
            'time' => \Carbon\Carbon::parse('2024-05-01 18:00'),
        ...
        DB::table('events')->insert([
            ...
            'time' => \Carbon\Carbon::parse('2024-06-06 19:00'),
        ...
        DB::table('events')->insert([
            ...
            'time' => \Carbon\Carbon::parse('2024-07-13 17:30'),
